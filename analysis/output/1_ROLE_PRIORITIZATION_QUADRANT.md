...
Based on your MBA/VC/PE background transitioning to Data Engineering
...
**Total prep needed**: Ongoing

### **TIER 4: Long-term (4-8 weeks)**
- Software Engineer
- ML Engineer
- Product Manager
...
## 💡 KEY INSIGHT: The "Strategic 60%" Rule

For Data Engineer (your #1 goal):
- **180 total questions**
- **Ignore**: DSA (32q) + Coding (4q) = 36 questions (20%)
- **Focus on**: 144 questions (80%)
- **Master 70% of those 144** = 101 questions
- **That's 56% overall BUT strategic 70% of what matters**

**This is VERY hireable** - many DE roles don't require Leetcode.
