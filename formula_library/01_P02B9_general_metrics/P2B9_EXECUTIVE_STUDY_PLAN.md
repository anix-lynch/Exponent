...
**Time:** 60-90 min  
**Source:** 76 questions → Flexible NSM + KPI Ladder for any product/feature
...
**Questions:** ~20 | **Priority:** 🟢 GREEN (High-yield)
...
- **Framework:** Baseline → Improvement → Validation → Scale
...
- **Adaptation:** Understand context → Apply framework → Define context-specific metrics
...
1. **Define NSM for Any Product/Feature** → Study Bucket 1, practice 5 questions
2. **Feature-Specific Metrics** → Study Bucket 2, practice 5 questions

### 🟡 YELLOW (High-yield but shaky - Practice questions)
3. **Product Improvement Metrics** → Study Bucket 3, practice 5 questions
4. **Context-Specific Adaptations** → Study Bucket 4, practice 5 questions
