# Executive Study Plan: P2 - NSM + KPI Ladder
**Approach:** GM-style, concept-level, not per-question  
**Time:** 2-3 hours total across 3 passes  
**Source:** 563 questions → 5 concept buckets → 3-5 high-impact buckets
...
### BUCKET 1: Define NSM for Existing Product
**Questions:** ~50 | **Priority:** 🟢 GREEN (Master this)

**Board Slide Bullets:**
- **What:** "What is the north star metric for [Product]?" or "Define success metrics for [Product]"
- **Framework:** NSM → Input KPIs → Leading Indicators → Guardrails → Dashboard
- **Key Insight:** NSM = single metric that captures user value + business value, actionable, predictive
- **Input KPIs:** What drives the NSM? (user behavior, supply/quality, monetization)
- **Guardrails:** What must NOT break? (trust, long-term health, cost/compliance)

**Concrete Examples:**
- "Airbnb NSM: Nights booked (user value = travel, business value = revenue)"
- "Instagram NSM: Daily active users who share (engagement + growth)"
- "Uber NSM: Completed rides per week (mobility + marketplace health)"

**Representative Questions (Do 5 only):**
- Q188: Define a north star metric for Airbnb.
- Q103: As the CEO of WhatsApp, what are the top 5 metrics you should focus on to measure the app's success?
- Q193: Define success for TikTok.
- Q33: As a Home Page PM at Netflix, how would you measure the success of your product?
...
### BUCKET 2: Measure Feature/Product Success
**Questions:** ~80 | **Priority:** 🟢 GREEN (High-yield)

**Board Slide Bullets:**
- **What:** "How would you measure success of [Feature/Product]?" or "After launching X, how do you measure impact?"
- **Framework:** Same NSM ladder, but focus on measurement approach
- **Key Insight:** Tie feature metrics to business outcomes, use leading indicators for early feedback
- **Approach:** Define success metric → Input KPIs → Leading indicators → Guardrails → Measurement plan

**Concrete Examples:**
- "Measure recommendation engine: NSM = click-through rate on recommendations, Input = relevance score, Leading = first-recommendation-click, Guardrails = content diversity"
- "Measure new feature: NSM = weekly active users of feature, Input = feature discovery rate, Leading = first-use rate, Guardrails = core product metrics don't drop"

**Representative Questions (Do 5 only):**
- Q19: After launching a new recommendation engine, how would you measure its impact on revenue?
- Q20: Airbnb made a feature to increase business travel. How would you measure its success?
- Q44: As a PM at Meta launching a new video conference product, define the success metrics.
- Q67: As a PM for Meta, how would you measure the success of launching a job marketplace?
...
### BUCKET 3: Design Product + Define Success
**Questions:** ~300 | **Priority:** 🟡 YELLOW (High volume, same framework)

**Board Slide Bullets:**
- **What:** "Design [Product] and define success metrics" - combines product design with metrics
- **Framework:** Product design → NSM → Input KPIs → Leading Indicators → Guardrails
- **Key Insight:** Same NSM framework, but start with user needs and product design first
- **Approach:** Understand user needs → Design solution → Define NSM → Build KPI ladder

**Concrete Examples:**
- "Design fitness app: User need = motivation, Solution = tracking + social, NSM = weekly active workouts, Input = workout logs, Leading = first-workout rate"
- "Design marketplace: User need = connect buyers/sellers, Solution = platform, NSM = successful transactions, Input = listings/applications, Leading = first-transaction rate"

**Representative Questions (Do 5 only):**
- Q31: As a Facebook PM, what would you do to design a product for hobbies?
- Q38: As a PM at a teleconferencing company, design a product for working from home.
- Q50: As a PM at Netflix, design something for kids.
- Q55: As a PM at Uber, what key metrics would you track to measure its success in a new city?
...
### BUCKET 4: Goal Setting & Team Metrics
**Questions:** ~30 | **Priority:** 🟡 YELLOW (High-yield but needs practice)

**Board Slide Bullets:**
- **What:** "How would you set goals for the team?" or "What metrics would you track for [Team/Product]?"
- **Framework:** Align team goals to NSM, break down into Input KPIs, set targets
- **Key Insight:** Goals should be tied to NSM, measurable, time-bound, and team-aligned
- **Approach:** Define team's contribution to NSM → Set goal → Break into Input KPIs → Track progress

**Concrete Examples:**
- "Instagram Stories team goal: Increase Stories creation by 20% (drives NSM: DAU)"
- "Netflix recommendation team goal: Increase recommendation CTR by 15% (drives NSM: watch time)"

**Representative Questions (Do 5 only):**
- Q63: As a PM for Instagram stories, how would you set the goal for the team?
- Q42: As a PM at DoorDash, define some goals and metrics for the business.
- Q116: As the PM for Instagram Reels, how would you set goals for monetization?
- Q88: As a product manager, what KPIs matter most to you?
...
### BUCKET 5: Creative/Abstract Product Design
**Questions:** ~100 | **Priority:** 🔴 RED (Low impact - skip for now)

**Examples:** "Design a refrigerator for Meta", "Design a time machine", "Design a product for flightless birds"

**Decision:** These are creative exercises that test product thinking, but the metrics framework is the same. Only study if you have extra time or they come up in your specific role.
...
1. **Define NSM for Existing Product** → Study Bucket 1, practice 5 questions
2. **Measure Feature/Product Success** → Study Bucket 2, practice 5 questions

### 🟡 YELLOW (High-yield but shaky - Practice questions)
3. **Design Product + Define Success** → Study Bucket 3, practice 5 questions
4. **Goal Setting & Team Metrics** → Study Bucket 4, practice 5 questions
...
- [ ] Walk through NSM + KPI Ladder framework in 2 minutes (NSM → Input KPIs → Leading Indicators → Guardrails → Dashboard)
- [ ] Define NSM for any product with user value + business value alignment
- [ ] Explain how to measure feature success with incremental metrics
- [ ] Set team goals aligned to NSM with Input KPIs
- [ ] Identify guardrails to prevent unintended consequences
...
**You're ready when:**
- You can explain the P2 framework to a non-technical person in 2 minutes
- You have 4 reusable narratives (one per bucket) that you can adapt
- You've practiced 15-20 representative questions total (5 per bucket, not all 563!)
- You focus on **structure, alignment, and systematic thinking**, not memorizing answers
