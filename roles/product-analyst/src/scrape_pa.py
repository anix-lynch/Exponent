"""
Scrape Product Analyst interview questions from Exponent
"""
import requests
...
def main():
    base_url = "https://www.tryexponent.com/questions?page={}&role=product-analyst"
    all_questions = []
    print("🚀 Starting Product Analyst scraper...")
    print("="*70)
    ...
    print("="*70)
    print(f"✅ Scraped {len(unique_questions)} unique Product Analyst questions")
