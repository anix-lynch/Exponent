"""
Software Engineer question scraper for Exponent
"""
import requests
...
def scrape_exponent_page(page_num=1):
    """Scrape one page of SWE questions"""
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=swe"
...
def scrape_all_pages(total_pages=30):
    """Scrape all pages of SWE questions (587 questions / 20 per page = ~30 pages)"""
    all_questions = []
...
if __name__ == "__main__":
    print("🚀 Scraping Exponent Software Engineer Questions")
    print("=" * 60)
    
    questions = scrape_all_pages(30)
