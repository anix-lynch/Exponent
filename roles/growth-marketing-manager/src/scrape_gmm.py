"""
Scrape Growth Marketing Manager interview questions from Exponent
"""
import requests
...
def scrape_exponent_page(url, page):
    """Scrape a single page of Growth Marketing Manager questions"""
...
def main():
    """Scrape all Growth Marketing Manager questions"""
    
    base_url = "https://www.tryexponent.com/questions?page={}&role=growth-marketing-manager"
    all_questions = []
    
    print("🚀 Starting Growth Marketing Manager scraper...")
    print("="*70)
    ...
    print("="*70)
    print(f"✅ Scraped {len(unique_questions)} unique Growth Marketing Manager questions")
