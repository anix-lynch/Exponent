"""
Product Manager question scraper for Exponent
"""
import requests
...
def scrape_exponent_page(page_num=1):
    """Scrape one page of PM questions"""
...
def scrape_all_pages(total_pages=86):
    """Scrape all pages of PM questions (1712 questions / 20 per page = 86 pages)"""
    all_questions = []
