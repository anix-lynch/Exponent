"""
Technical Program Manager question scraper for Exponent
"""
import requests
...
def scrape_exponent_page(page_num=1):
    """Scrape one page of TPM questions"""
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=tpm"
...
def scrape_all_pages(total_pages=10):
    """Scrape all pages of TPM questions (185 questions / 20 per page = ~10 pages)"""
    all_questions = []
...
if __name__ == "__main__":
    print("🚀 Scraping Exponent Technical Program Manager Questions")
    print("=" * 60)
    
    questions = scrape_all_pages(10)
