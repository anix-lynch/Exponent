"""
Scrape BizOps & Strategy questions from Exponent
"""
import requests
...
def scrape_page(page_num):
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=bizops"
...
def main():
    ...
    print(f"🚀 Scraping BizOps & Strategy questions from Exponent...")
    ...
    print(f"\n✅ Scraped {len(unique_questions)} unique BizOps & Strategy questions")
