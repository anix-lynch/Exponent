"""
Scrape Data Scientist questions from Exponent
"""
import requests
...
def scrape_page(page_num: int = 1):
    ...
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=data-science"
    ...
    try:
        ...
        # Find all question links (a tags with href containing /questions/)
        ...
        for link in question_links:
            ...
            # Filter out non-question text (like "I was asked this", "answers", etc.)
...
def main():
    all_questions = []
    print("🚀 Starting Data Scientist scraper...")
    print("="*70)
    
    # Try up to 20 pages (165 questions / ~20 per page = ~9 pages)
    ...
    print("="*70)
    print(f"✅ Scraped {len(unique_questions)} unique Data Scientist questions")
