"""
Data Engineer question scraper for Exponent
"""
import requests
...
def scrape_exponent_page(page_num=1):
    """Scrape one page of Data Engineer questions"""
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=data-engineer"
...
def scrape_all_pages(total_pages=8):
    """Scrape all pages of Data Engineer questions (154 questions / 20 per page = ~8 pages)"""
    all_questions = []
...
if __name__ == "__main__":
    print("🚀 Scraping Exponent Data Engineer Questions")
    print("=" * 60)
    
    questions = scrape_all_pages(8)
