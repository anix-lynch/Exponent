"""
Scrape ML Engineer questions from Exponent
"""
import requests
...
def scrape_page(page_num):
    url = f"https://www.tryexponent.com/questions?page={page_num}&role=ml-engineer"
...
def main():
    ...
    print(f"🚀 Scraping ML Engineer questions from Exponent...")
    ...
    print(f"\n✅ Scraped {len(unique_questions)} unique ML Engineer questions")
